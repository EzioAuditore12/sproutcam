...
const ProgressBarArea: FC<ProgressBarAreaProps> = memo(({ isVisible, progress }) => {
  ...
  const rProgressBarAnimatedStyle = useAnimatedStyle(() => {
    const width = interpolate(progress.get(), [0, 1], [0, 100], Extrapolation.CLAMP);
...
ProgressBarArea.displayName = "ProgressBarArea";
